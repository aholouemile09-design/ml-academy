...
export default function ModulePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
      ...
      {/* Les principes défilent pendant qu'on travaille : c'est le fait de les
          recroiser au bon moment qui les ancre, pas de les avoir lus une fois. */}
      <div className="-mx-4 sm:-mx-6 mb-8">
        <PrincipesBandeau />
      </div>

      {/* Syllabus : objectifs, prérequis, lectures.
          Le problem set n'est masqué ici que si le module a un exercice final :
          celui-ci le reprend en fin de parcours, là où l'élève peut réellement
          le faire. Sur les modules pas encore migrés, on le laisse en haut
          plutôt que de le rendre invisible. */}
