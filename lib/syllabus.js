...
export const SYLLABUS = {
  ...
  fondamentaux: {
    outcomes: [
      "Vérifier son éligibilité et monter un dossier de candidature défendable en audit",
      "Décrire le format de l'examen 2026 : structure, durée, types de questions",
      "Situer un sujet dans les domaines People, Process et Business de l'ECO 2026",
      "Identifier la structure organisationnelle d'un contexte et l'autorité du PM qui en découle",
      "Construire un plan de préparation daté et pondéré par l'ECO",
    ],
    ...
    problemSet: {
      title: "Problem Set P1 — Dossier de candidature et plan de préparation",
      ...
      tasks: [
        "Calcule ton éligibilité : voie retenue, mois d'expérience à diriger des projets, 35 heures de formation",
        "Rédige les descriptions de 3 projets au format PMI, prêtes à survivre à un audit",
        "Établis ton plan de révision daté, pondéré par l'ECO 2026 (33 / 41 / 26)",
        "Définis ta stratégie du jour J : rythme par question, gestion des deux pauses, seuils d'alerte",
      ],
      rubric: [
        { criterion: "Éligibilité calculée et justifiée", points: 25 },
        { criterion: "Descriptions de projets défendables en audit", points: 30 },
        { criterion: "Plan de révision daté et pondéré par l'ECO", points: 25 },
        { criterion: "Stratégie de temps chiffrée pour le jour J", points: 20 },
      ],
    },
  },
