...
**Exercice** : convertis l'interface de tes modules de cours en TypeScript avec des generics pour la fonction de recherche par ID.`,
      },
      {
        id: "ts-3",
...
**Exercice** : ajoute TypeScript et Zod à ton API Express de prédictions — valide le body de chaque route et génère les types depuis les schémas Zod.`,
      },
    ],
    quiz: [
      {
